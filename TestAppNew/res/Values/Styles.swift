...
//  Styles.swift
//  MINSA-TRIAJE
//  Created by Raul Quispe on 5/17/20.
...
class Styles {
    ...
    static let purpleColor = SunarpColors.greenLight
...
class Style {
    ...
    /*
    func apply(textStyle: TextStyle, to textField: MFTextField) {
        let attributes = attributesForStyle(textStyle)
        textField.font = UIFont.systemFont(ofSize: 14)//attributes.font
...
extension UIFont {
    static let GraphikBold:String = "SFProText-Bold"
    static let GraphikSemiBold = "SFProText-Bold"
    static let GraphikMedium = "SFProText-Regular"
    static let GraphikLight = "SFProText-Light"
    static let GraphikRegular = "SFProText-Regular"
